...
if sys.platform.startswith('linux') == True:
	...
	for file in os.listdir("/usr/lib/vmware-vcops/user/plugins/inbound/FusionDirectorAdapter/conf/dashboards/"):
...
#	
#	for file in os.listdir("/usr/lib/vmware-vcops/user/plugins/inbound/FusionDirectorAdapter/conf/reskndmetrics/"):
#		reskndcmd = reskndcmd + const + "$VMWARE_PYTHON_BIN ops-cli.py file import reskndmetric $VCOPS_BASE/user/plugins/inbound/FusionDirectorAdapter/conf/reskndmetrics/" + file + " --force"
...
#	
#	for file in os.listdir("/usr/lib/vmware-vcops/user/plugins/inbound/FusionDirectorAdapter/conf/reports/"):
#		reportcmd = reportcmd + const + "$VMWARE_PYTHON_BIN ops-cli.py report import $VCOPS_BASE/user/plugins/inbound/FusionDirectorAdapter/conf/reports/" + file + " --force"
